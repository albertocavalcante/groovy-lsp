...
dependencies {
    ...
    implementation("org.apache.groovy:groovy-ant:5.0.2")
    implementation("org.apache.groovy:groovy-console:5.0.2")
    implementation("org.apache.groovy:groovy-json:5.0.2") // Required for CodeNarc JsonSlurper
